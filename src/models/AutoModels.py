from transformers import (
    AutoTokenizer, AutoModelForSeq2SeqLM, AutoConfig, AutoModelForCausalLM, 
    PreTrainedTokenizerFast, BartTokenizerFast, BatchEncoding
)
import torch
...
# class CustomBartTokenizerFast(BartTokenizerFast):
#     """
#     BOS 토큰을 자동으로 추가하지 않도록 tokenize 함수의 기본 동작을 변경한다.
#     """
#     def __init__(self, *args, **kwargs):
...
def load_tokenizer_and_model_for_train(config, device):
    ...
    #     tokenizer = CustomBartTokenizerFast.from_pretrained(**tokenizer_args_dict)
